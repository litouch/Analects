      ...
      const dailyHTML = `
        <div class="analects-daily">
          ...
          <div class="analects-daily-share">
            <span class="analects-daily-share-label">分享到：</span>
            <div class="analects-share-buttons">
              ...
              <button class="analects-share-btn wechat" 
                      onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'none' ? 'block' : 'none'"
                      title="微信分享">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 0 1 .213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.326.326 0 0 0 .167-.054l1.903-1.114a.864.864 0 0 1 .717-.098 10.16 10.16 0 0 0 2.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18 0 .659-.52 1.188-1.162 1.188-.642 0-1.162-.529-1.162-1.188 0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18 0 .659-.52 1.188-1.162 1.188-.642 0-1.162-.529-1.162-1.188 0-.651.52-1.18 1.162-1.18zm5.34 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.428-2.687 3.72-1.78 6.22.942 2.453 3.666 4.229 6.884 4.229 2.498 0 4.738-.615 6.744-1.746l1.708 1.005c.026.015.058.026.09.026.124 0 .222-.107.222-.235 0-.06-.022-.15-.041-.203l-.35-1.338a.523.523 0 0 1 .193-.607c1.675-1.204 2.7-3.027 2.7-5.009 0-3.639-3.533-6.617-7.890-6.128zm-2.463 7.707c-.535 0-.97-.399-.97-.892 0-.493.435-.892.97-.892.537 0 .97.399.97.892 0 .493-.433.892-.97.892zm4.905 0c-.535 0-.97-.399-.97-.892 0-.493.435-.892.97-.892.537 0 .97.399.97.892 0 .493-.433.892-.97.892z"/>
                </svg>
              </button>
              <div style="display: none; position: absolute; background: white; padding: 8px; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); font-size: 12px; color: #666;">
                请使用微信扫码分享
              </div>
